...
class CausalGraphConfig:
    ...
    def __init__(self,
        ...
        # Validate input.
        assert graph_complexity in [0, 10, 20, 30, 40], \
...
class FunctionConfig:
    ...
    def __init__(self,
        ...
        # Validate input.
        assert function_complexity in [0, 10, 20, 30, 40], \
...
class DataGenerationConfig:
    ...
    def __init__(self,
        ...
        assert complexity in [0, 10, 20, 30, 40], f'complexity must be one of 0, 10, 20, or 30. Got {complexity}.'
